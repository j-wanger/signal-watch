...
- [ ] The aml-substrate **BO-graph emission handoff brief** (`docs/substrate-bo-graph-emission-PLAN-BRIEF.md`) names the 3-part ask (PartyGraphView · `related_parties[]` · non-tautological C14) + the consume-side 1:1 mapping; sibling-executed
