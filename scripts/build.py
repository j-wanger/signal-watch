...
def main() -> None:
    ...
    # the gate console; 'triage' = only the triage console; 'launcher' = only the dist/index.html
    # front door; 'all' = every typology + corpus + news + console + triage + launcher; else a typology.
    ...
    want_typologies = target not in ("corpus", "news", "console", "triage", "launcher")
