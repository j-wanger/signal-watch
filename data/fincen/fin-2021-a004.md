<!-- source-of-truth: verbatim text of FinCEN advisory FIN-2021-A004 -->
...
with: The Financial Crimes Enforcement Network (FinCEN) is
• Chief Executive Officers updating and replacing its October 1, 2020 Advisory on
• Chief Operating Officers Ransomware and the Use of the Financial System to Facilitate
• Chief Compliance Officers Ransom Payments.1 This updated advisory is in response to
• Chief Risk Officers the increase of ransomware attacks in recent months against
• AML/BSA Departments critical U.S. infrastructure, such as the May 2021 ransomware
• Legal Departments attack that disrupted the operations of Colonial Pipeline, the
• Cyber and Security largest pipeline system for refined oil products in the United
Departments States. This attack led to widespread gasoline shortages
• Customer Service Agents that affected tens of millions of Americans. Other recent
• Bank Tellers targets include entities in the manufacturing, legal services,
insurance, financial services, health care, energy, and food
SAR Filing Request
production sectors.
FinCEN requests financial
institutions reference this FinCEN issued the original advisory to alert financial
advisory in SAR field 2 (Filing institutions to predominant trends, typologies, and potential
Institution Note to FinCEN) and indicators of ransomware and associated money laundering
the narrative by including the activities. The advisory provided information on: (1) the role
following key term: “CYBER of financial intermediaries in the processing of ransomware
...
1. FIN-2020-A006
2. See U.S. Department of the Treasury Press Release, “Treasury Continues Campaign to Combat Ransomware As Part
...
4. See DOJ Report of the Attorney General’s Cyber Criminal Task Force, Cryptocurrency: An Enforcement Framework
...
5. Both extortion and computer fraud and abuse are specified unlawful activities and predicate offenses to money
laundering. See 18 U.S.C § 1956(c)(7).
6. “Hosted wallets” are CVC wallets where the CVC exchange receives, stores, and transmits the CVCs on behalf of their
...
exchanges.  Criminals prefer to launder their ransomware proceeds in jurisdictions with weak anti-
money laundering and countering financing of terrorism (AML/CFT) controls.
...
EXCHANGES
Cash-Out
| VICTIM | DEPOSITORY | CVC | SUSPICIOUS | MONEY  | DEXS | CVC | ATTACKER/ |
| ------ | ---------- | --- | ---------- | ------ | ---- | --- | --------- |
CVC ADDRESS LAUNDERING
|     | INSTITUTIONS | EXCHANGES |     |     |        | EXCHANGES | AFFILIATES |
| --- | ------------ | --------- | --- | --- | ------ | --------- | ---------- |
| KEY |              | CIC       |     |     | MIXERS |           |            |
DFIR: Digital Forensic and
|   Incident Response           |     | Entities     |     |     | Entities      |     |     |
| ----------------------------- | --- | ------------ | --- | --- | ------------- | --- | --- |
| CIC:  Cyber Insurance Company |     | Facilitating |     |     | Facilitating  |     |     |
DEXs: Decentralized Exchanges
|     |     | Victim Payments |     |     | Obfuscation |     |     |
| --- | --- | --------------- | --- | --- | ----------- | --- | --- |
7.  Mixing or tumbling involves the use of mechanisms to break the connection between an address sending CVC and
