<!-- source-of-truth: verbatim text of FINTRAC indicators guidance FINTRAC-GUID-FINANCIAL-ENTITIES -->
<!-- acquired via scripts/acquire_fincen.py; Crown copyright (© His Majesty the King in Right of Canada); reproduced for non-commercial use with attribution per FINTRAC's Terms & Conditions — NOT public domain -->
...
* [Françaisfr](/guidance-directives/transaction-operation/indicators-indicateurs/fin_mltf-fra)

[![Government of Canada](/theme-wet10/GCWeb/assets/sig-blk-en.svg) / Gouvernement du Canada](https://www.canada.ca/en.html)

## Search

Search FINTRAC website
...
2. [FINTRAC](/intro-eng)
3. [Obligations and guidance](/guidance-directives/guidance-directives-eng)
...
:   Insurance against loss or damage caused by:
    ...
    5. any other matter affecting the title to property or affecting the right to the use and enjoyment of property. (assurance titre)
...
![Symbol of the Government of Canada](/theme-wet10/GCWeb/assets/wmms-blk.svg)
